#!/bin/sh
# configversion: 656ada683ce62137e8ef5b917645f259
...
export EDITOR=nvim
export BEMENU_OPTS="--border 3 --center --fixed-height --fn 'cozette 8' --line-height 20 --list 32 down --margin 40 --no-overlap --no-spacing --scrollbar autohide --wrap --nf #00AA00 --tf #00FF00 --hf #00FF00 --af #008F00 --bdr #20BB20"
